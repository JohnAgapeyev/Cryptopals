...
int main(void) {
    ...
    if (CRYPTO_memcmp(client_hmac, server_hmac, 32) == 0) {
        printf("Set 5 Challenge 36 HMAC verified successfully!\n");
    } else {
        printf("Set 5 Challenge 36 FAILED HMAC unable to be verified!\n");
    }
