...
unsigned char *diffie_helman_1(void) {
...
unsigned char *diffie_helman_2(void) {
    const char *p_str = "ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024\
e088a67cc74020bbea63b139b22514a08798e3404ddef9519b3cd\
3a431b302b0a6df25f14374fe1356d6d51c245e485b576625e7ec\
6f44c42e9a637ed6b0bff5cb6f406b7edee386bfb5a899fa5ae9f\
...
unsigned char *diffie_helman_3(void) {
    const char *p_str = "ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024\
e088a67cc74020bbea63b139b22514a08798e3404ddef9519b3cd\
3a431b302b0a6df25f14374fe1356d6d51c245e485b576625e7ec\
6f44c42e9a637ed6b0bff5cb6f406b7edee386bfb5a899fa5ae9f\
...
fffffffffffff";
    ...
    const char *pminusone = "ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024\
e088a67cc74020bbea63b139b22514a08798e3404ddef9519b3cd\
3a431b302b0a6df25f14374fe1356d6d51c245e485b576625e7ec\
6f44c42e9a637ed6b0bff5cb6f406b7edee386bfb5a899fa5ae9f\
24117c4b1fe649286651ece45b3dc2007cb8a163bf0598da48361\
...
ffffffffffffe";
    ...
    BIGNUM *g = hex_to_bignum(pminusone);
...
int main(void) {
    {
        unsigned char *secret_key = diffie_helman_1();

        //Need to use 01 instead of 1 because that's how it's converted in OpenSSL
        unsigned char *mitm_key = sha1_hash((const unsigned char *) "01", 2);
        ...
        printf("Set 5 Challenge 35 MITM decrypted without issues!\n");
    ...
    {
        unsigned char *secret_key = diffie_helman_2();
    ...
    {
        unsigned char *secret_key = diffie_helman_3();
